<template>
  ...
  <div class="catList__warp">
    ...
    <CatCard :cat-info-data="catData.data" :screen-size="screenSize" @loading-switcher="loadingSwitcher" />
    <PaginationComponent :pagination-links="catData.paginationLinks" :screen-size="screenSize"
      @fetch-animal-data="fetchAnimalData" />
  </div>
  <FilterModal :filter-modal-switcher="filterModalSwitcher" :shelter-data="shelterData.option" :color="catData.color"
    :screen-size="screenSize" @filter-switcher="filterSwitcher" @shelter-filter="shelterFilter"
    @fetch-animal-data="fetchAnimalData" />
</template>
<script>
